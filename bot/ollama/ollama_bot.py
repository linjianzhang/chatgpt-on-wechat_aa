...
from bot.ollama.ollama_ai_image import OllamaAIImage
...
# OllamaAI对话模型API
class OLLAMAAIBot(Bot, OllamaAIImage):
    def __init__(self):
        super().__init__()
        ...
        #self.client = OpenAI(api_key=conf().get("ollama_ai_api_key")) #还是使用openai的接口
